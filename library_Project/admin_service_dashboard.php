...
.innerright {
    background-color:rgb(137, 217, 236);
}

.greenbtn {
    background-color:rgb(201, 225, 235);
    color: black;
    width: 95%;
    height: 40px;
    margin-top: 8px;
...
th{
    background-color:rgb(138, 214, 161);
    color: black;
}
td{
...
elseif($msg=="fail"){
    ...
    ?>
        ...
        <div class="container">
        <div class="innerdiv">
            <div class="row"><img class="imglogo" src="images/li2.jpg"/></div>
